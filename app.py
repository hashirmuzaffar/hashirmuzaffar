...
page = st.sidebar.radio("Go to", ["Home", "Projects", "Experience", "Contact", "Academic Qualifications", "Professional Experience", "Major Projects", "Extra-Curricular Activities", "Certifications", "Skills"])
